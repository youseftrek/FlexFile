  ...
  return (
    <section className="max-w-[1920px] w-full p-8 mb-4 flex flex-col justify-center items-center mx-auto">
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <p>
          At FlexFile, we are committed to safeguarding your privacy. This
        ...
        <ul className="list-disc pl-6">
          <li>
            ...
            your interaction with our website, such as the pages you visit, your
            IP address, browser type, device type, and referral URLs. This
        ...
        <h2 className="text-xl font-bold mt-6 mb-4">5. Third-Party Links</h2>
        <p>
        ...
        <h2 className="text-xl font-bold mt-6 mb-4">8. Contact Us</h2>
        <p>
          If you have any questions or concerns about this Privacy Policy or the
          data we collect, please contact us at{" "}
          <a href="mailto:youseftark.business@gmail.com">
            youseftark.business@gmail.com
          </a>
          .
        </p>

        <p className="text-lg font-bold mt-6">
          By using FlexFile, you agree to the practices outlined in this Privacy
